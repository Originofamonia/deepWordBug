...
class Network(Model):
    ...
    def containers(self):
        ...
        :py:class:`~docker.outputs.containers.Container` objects.
        """
        return [
    ...
    def connect(self, container, *args, **kwargs):
        ...
        Args:
            container (str): Container to connect to this network, as either
                an ID, name, or :py:class:`~docker.outputs.containers.Container`
                object.
    ...
    def disconnect(self, container, *args, **kwargs):
        ...
        Args:
            container (str): Container to disconnect from this network, as
                ...
                :py:class:`~docker.outputs.containers.Container` object.
